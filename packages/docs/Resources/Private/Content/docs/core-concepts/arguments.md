...
These are serialized and passed to JavaScript during hydration, and typed - see [Typed Client Props](/docs/core-concepts/hydration#content-typed-client-props) for the full pipeline from a PHP value to a typed JS one, with examples.
