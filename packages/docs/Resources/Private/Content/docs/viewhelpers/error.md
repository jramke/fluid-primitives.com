...
|------|------|-------------|----------|--------|
| `when` | bool | The condition that triggers the exception | No | - |
| `message` | string | The exception message | Yes | 'An error occurred in Fluid.' |
| `code` | int | The exception code | Yes | 1759132287 |
