...
|------|------|-------------|----------|--------|
| `name` | string | The name under which the hydration data should be exposed | No | - |
| `id` | string | An optional identifier for the hydration data. If not provided, a unique id will be generated. | Yes | - |
| `props` | mixed | The props/data to expose to the client | No | - |
| `controlled` | boolean | Whether the hydration data is for a controlled component | Yes | false |
