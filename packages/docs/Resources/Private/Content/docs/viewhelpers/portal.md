...
|------|------|-------------|----------|--------|
| `name` | string | The name of the target container | Yes | 'default' |
| `disabled` | bool | If set to true, the portal functionality is disabled and content is rendered in place | Yes | false |
